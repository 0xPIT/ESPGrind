...
**Update:** I've since ported it to a fairly cheap [ESP32-S3-Touch-LCD-2.8](https://www.waveshare.com/wiki/ESP32-S3-Touch-LCD-2.8) board that has a nice capacitive touchscreen and great screen. See `src/bsp/` for the code. With some dremeling, it fits into the grinder's original cover, I had some 1mm acrylic lasercut to make it look nice. There's also some effort in a [separate branch](https://github.com/0xPIT/ESPGrind/tree/cyd-2432S024C) to port it to the [ESP32 CYD](https://github.com/witnessmenow/ESP32-Cheap-Yellow-Display) with capacitive touchscreen. It mostly works, but I could not get the display to work properly – there are some artefacts.
