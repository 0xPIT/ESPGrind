...
#define TOUCH_I2C_CONFIG_CLK_FLAGS I2C_SCLK_SRC_FLAG_FOR_NOMAL
...
#define TOUCH_CONFIG_X_MAX BSP_LCD_V_RES
#define TOUCH_CONFIG_Y_MAX BSP_LCD_H_RES
#define TOUCH_CONFIG_LEVELS_RESET false
#define TOUCH_CONFIG_LEVELS_INTERRUPT false
